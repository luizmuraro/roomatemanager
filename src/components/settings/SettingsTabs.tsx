  ...
  return (
    <Tabs defaultValue="profile" className="space-y-4">
      <TabsList className="grid h-auto w-full grid-cols-2 gap-1 p-1 md:grid-cols-4">
        ...
        <TabsTrigger value="roommate" className="gap-2"><Users className="h-4 w-4" />Parceiro</TabsTrigger>
        ...
        <Card className="rounded-lg border-gray-200 shadow-sm">
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between rounded-lg bg-gray-50 p-4">
              <div>
                <p className="font-medium text-gray-900">{settings.roommate.name}</p>
                <p className="text-sm text-gray-500">{settings.roommate.email}</p>
                <p className="text-xs text-green-600">Conectado desde {settings.roommate.connectedSince}</p>
              </div>
              <Badge className="bg-green-100 text-green-700 hover:bg-green-100">Ativo</Badge>
            </div>
            <div className="flex flex-wrap gap-2">
              <Button variant="outline">Gerenciar</Button>
              <Button className="bg-blue-600 hover:bg-blue-700">Convidar roommate</Button>
            </div>
          </CardContent>
        </Card>
      </TabsContent>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center justify-between rounded-lg border border-gray-200 p-3">
              <div>
                ...
                <p className="text-sm text-gray-600">Quando seu roommate adicionar despesas.</p>
              </div>
              <Switch
