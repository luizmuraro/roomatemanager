...
export const mockShoppingItems: ShoppingItem[] = [
  ...
  { id: "shop-2", name: "Leite integral", quantity: 1, unit: "L", checked: false, addedBy: "roommate", emoji: "🥛" },
  { id: "shop-3", name: "Detergente", quantity: 2, unit: "un", checked: false, addedBy: "me", emoji: "🧽" },
  { id: "shop-4", name: "Peito de frango", quantity: 1, unit: "kg", checked: true, addedBy: "roommate", emoji: "🥩" },
